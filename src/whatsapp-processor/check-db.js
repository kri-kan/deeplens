...
import { getWhatsAppDbClient } from './src/clients/db.client.js';
import { initializeWhatsAppDbClient } from './src/clients/db.client.js';
...
async function checkDatabase() {
    try {
        ...
        if (chatCount > 0) {
            ...
            console.log('\n📋 Sample chats:');
            sampleChats.rows.forEach((chat, i) => {
