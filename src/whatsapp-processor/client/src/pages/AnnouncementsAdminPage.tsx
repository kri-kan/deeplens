...
export default function AnnouncementsAdminPage() {
    ...
    const handleBulkExclude = async () => {
        ...
        try {
            ...
            console.error('Failed to bulk exclude announcements:', error);
        }
    };
    ...
    const handleSyncToggle = async (ev: any, checked?: boolean) => {
        try {
            const newState = await updateSyncSettings({ trackAnnouncements: checked });
        ...
        <div style={{ height: '100%', overflowY: 'auto', padding: '16px' }}>
            <Stack tokens={{ childrenGap: 8 }}>
                <Stack horizontal horizontalAlign="space-between" verticalAlign="center">
                    ...
                    <Toggle
                        label="Sync"
                        checked={processingState?.trackAnnouncements ?? true}
