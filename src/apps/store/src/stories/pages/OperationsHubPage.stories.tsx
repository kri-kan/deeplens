    ...
    items: [
      {
        ...
        icon: <LuUsers size={20} color="#6366F1" />,
        route: '/system/users',
        color: '#6366F1',
      },
      {
        ...
        icon: <LuShieldCheck size={20} color="#0D9488" />,
        route: '/system/roles',
        color: '#0D9488',
      },
    ],
    ...
    items: [
      {
        ...
        icon: <LuTag size={20} color="#8B5CF6" />,
      ...
      },
      {
        ...
        icon: <LuTruck size={20} color="#10B981" />,
        route: '/orders',
        color: '#10B981',
      },
    ],
    ...
    items: [
      {
        ...
        icon: <LuShoppingBag size={20} color="#EC4899" />,
      ...
      },
      {
        ...
        icon: <LuPlus size={20} color="#10B981" />,
    ...
    items: [
      {
        ...
        icon: <LuLayoutDashboard size={20} color="#64748B" />,
      ...
      },
      {
        ...
        icon: <LuDatabase size={20} color="#8B5CF6" />,
      ...
      },
      {
        ...
        icon: <LuImage size={20} color="#F97316" />,
      ...
      },
      {
        ...
        icon: <RiInstagramFill size={20} color="#E1306C" />,
      ...
      },
      {
        ...
        icon: <RiWhatsappFill size={20} color="#25D366" />,
      ...
      },
      {
        ...
        icon: <LuExternalLink size={20} color="#0284C7" />,
    ...
    items: [
      {
        ...
        icon: <LuMegaphone size={20} color="#F59E0B" />,
