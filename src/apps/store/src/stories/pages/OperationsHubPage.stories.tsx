    ...
    items: [
      {
        ...
        icon: <LuTag size={36} color="#8B5CF6" />,
      ...
      },
      {
        ...
        icon: <LuUsers size={36} color="#3B82F6" />,
      ...
      },
      {
        ...
        icon: <LuTruck size={36} color="#10B981" />,
        route: '/orders',
        color: '#10B981',
      },
    ],
    ...
    items: [
      {
        ...
        icon: <LuShoppingBag size={36} color="#EC4899" />,
      ...
      },
      {
        ...
        icon: <LuPlus size={36} color="#10B981" />,
    ...
    items: [
      {
        ...
        icon: <LuLayoutDashboard size={36} color="#64748B" />,
      ...
      },
      {
        ...
        icon: <LuDatabase size={36} color="#8B5CF6" />,
      ...
      },
      {
        ...
        icon: <LuImage size={36} color="#F97316" />,
      ...
      },
      {
        ...
        icon: <LuExternalLink size={36} color="#0284C7" />,
    ...
    items: [
      {
        ...
        icon: <LuMegaphone size={36} color="#F59E0B" />,
