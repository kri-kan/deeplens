...
namespace DeepLens.Infrastructure.Services
{
    public class AppSettingsService : IAppSettingsService
    {
        ...
        private static List<AppSetting> GetDefaultSettings() => new()
        {
            ...
            new() { Key = "Youtube:QuotaLastUpdated", Section = "YouTube", Label = "Quota Last Updated", Description = "Date the quota was last updated.", IsSecret = false, DataType = "datetime", Value = "2025-01-01T00:00:00Z" },
