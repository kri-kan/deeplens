...
export const INITIAL_COLOR_GROUPS: StoreColorGroup[] = [
  ...
  {
    id: 'cg-quad',
    name: 'Ruby, Emerald, Royal & Gold Quad',
    colorwayCode: 'VF2B58-QUD',
    template: 'multi-shade',
    slotA: '#C0392B', // Ruby Red
    slotB: '#1B4D3E', // Emerald Green
    slotC: '#2035C0', // Royal Blue
    slotD: '#D4AF37', // Antique Gold
    colors: ['#C0392B', '#1B4D3E', '#2035C0', '#D4AF37'],
    colorCount: 4,
    isAvailable: true,
  },
  {
    id: 'cg-mosaic',
    name: 'Bandhani Rainbow Mosaic',
    colorwayCode: 'VF2B58-MOS',
    template: 'multicolor',
    slotA: '#E91E63',
    colors: ['#E91E63'],
    colorCount: 1,
