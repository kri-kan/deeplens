...
4. **Propagate cross-agent updates:**
   ...
   ```
   - If the merged decision included or triggered documentation changes, also append a short doc-change record to the agent history or create an entry under `.squad/doc-changes/` summarizing files changed, PR/commit reference, and rationale. This makes doc edits discoverable and searchable by Scribe.
